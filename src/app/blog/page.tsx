    ...
    <div className="min-h-screen bg-[#09090b]">
      ...
      <div className="max-w-6xl mx-auto px-6 mb-16">
        <Link href={`/blog/${posts[0].slug}`}>
          <div className="group relative p-8 md:p-12 bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 rounded-3xl border border-zinc-700/50 hover:border-zinc-600/50 transition-all">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-1">
                <span className="inline-block px-3 py-1 bg-orange-500/10 text-orange-400 text-sm rounded-full mb-4">
                  {posts[0].category}
                </span>
              ...
              <div className="hidden md:flex items-center justify-center w-48 h-48 bg-gradient-to-br from-orange-500/20 to-pink-500/20 rounded-2xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {posts.slice(1).map((post) => (
            <Link key={post.slug} href={`/blog/${post.slug}`}>
              <article className="group h-full p-6 bg-zinc-900/50 rounded-2xl border border-zinc-800/50 hover:border-zinc-700/50 transition-all">
                <span className="inline-block px-2 py-1 bg-zinc-800 text-zinc-400 text-xs rounded mb-4">
                  {post.category}
                </span>
                ...
                <div className="flex items-center justify-between text-xs text-zinc-600">
                  ...
                  <span className="flex items-center gap-1 text-orange-400 opacity-0 group-hover:opacity-100 transition-opacity">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20">
        <div className="p-8 md:p-12 bg-gradient-to-r from-orange-500/10 to-pink-500/10 rounded-3xl border border-zinc-800/50 text-center">
